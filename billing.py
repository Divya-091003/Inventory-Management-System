...
class BillClass:
    def __init__(self, root):
        ...
        txt_search=Entry(ProductFrame2,font=("times new roman",15),bg="lightyellow", textvariable=self.var_search).place(x=128,y=49,width=150,height=22)
        ...
        btn_show_all=Button(ProductFrame2,text="Show All",command=self.show
                            ,font=("goudy old style",15),bg="#083531",fg="white",cursor="hand2").place(x=284,y=10,width=100,height=25)
        ...
        txt_contact=Entry(CustomerFrame,textvariable=self.var_contact,font=("times new roman",13),bg="lightyellow").place(x=343,y=35,width=140)
        ...
        lblp_name=Label(Add_CartWidgetsFrame,text="Product Name",font=("times new romann",15),bg="white").place(x=5,y=5)
        txt_p_name=Entry(Add_CartWidgetsFrame,textvariable=self.var_pname,font=("times new romann",15),bg="lightyellow",state='readonly').place(x=5,y=30)
        
        lblp_price=Label(Add_CartWidgetsFrame,text="Price per Qty",font=("times new romann",15),bg="white").place(x=250,y=5)
        txt_p_price=Entry(Add_CartWidgetsFrame,textvariable=self.var_price,font=("times new romann",15),bg="lightyellow",state='readonly').place(x=250,y=30,width=150)

        lblp_qty=Label(Add_CartWidgetsFrame,text="Quantity",font=("times new romann",15),bg="white").place(x=420,y=5)
        txt_p_qty=Entry(Add_CartWidgetsFrame,textvariable=self.var_qty,font=("times new romann",15),bg="lightyellow").place(x=420,y=30,width=60)

        self.lbl_inStock=Label(Add_CartWidgetsFrame,text="In Stock",font=("times new romann",15),bg="white")
        ...
        btn_add_cart=Button(Add_CartWidgetsFrame,text="Add | Update Cart",command=self.add_update_cart,font=("times new roman",15,"bold"),bg="orange",cursor="hand2").place(x=340,y=70,width=150,height=30)
...
###########billing area#################
        ...
        self.lbl_dicount.place(x=124,width=120,y=5,height=70)

        self.lbl_net_pay=Label(billMenuFrame,text='Net Pay\n[0]',font=("goudy old style",15,"bold"),bg="#607d8b",fg="white")
        self.lbl_net_pay.place(x=246,width=160,y=5,height=70)
        ...
        btn_print.place(x=2,width=120,y=80,height=50)
        ...
        btn_clear_all.place(x=124,width=120,y=80,height=50)
        ...
        btn_generate.place(x=246,width=160,y=80,height=50)
        ################footer#############
        footer=Label(self.root,text="INVENTORY MANAGEMENT SYSTEM | DEVELOPED BY ARCHANA AND DIVYA",font=("times new roman",11),bg="#4d636d",fg="white",bd=0,cursor="hand2").pack(side=BOTTOM,fill=X)
        self.show()
        #self.bill_top()
        self.update_date_time()

        #self.lbl_amnt=Label(billMenuFrame,text='Bill Amount',font=("goudy old style",15,"bold"),bg="#3f51b5",fg="white")
        #self.lbl_amnt.place(x=2,width=120,y=5,height=70)
